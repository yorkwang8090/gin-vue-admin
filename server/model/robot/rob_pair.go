...
type RobPair struct {
	...
	Exid            *uint  `json:"exid" form:"exid" gorm:"column:exid;comment:所属交易所;size:10;"`                                    //所属交易所
	Symbol          string `json:"symbol" form:"symbol" gorm:"column:symbol;comment:交易对   BTC_USDT;size:50;"`                     //交易对   BTC_USDT
	PricePrecision  *uint  `json:"pricePrecision" form:"pricePrecision" gorm:"column:price_precision;comment:价格小数位数;size:10;"`    //价格小数位数
	VolumePrecision *uint  `json:"volumePrecision" form:"volumePrecision" gorm:"column:volume_precision;comment:数量小数位数;size:10;"` //数量小数位数
	...
	Addtime         *uint  `json:"addtime" form:"addtime" gorm:"column:addtime;type:int4;comment:添加时间;size:10;"`                  //添加时间
