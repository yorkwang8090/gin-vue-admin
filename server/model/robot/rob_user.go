...
// user表 结构体  RobUser
type RobUser struct {
	Id           uint   `json:"id" form:"id" gorm:"primarykey;column:id;comment:主键;"`                                //主键
	...
	Exptime      *uint  `json:"exptime" form:"exptime" gorm:"column:exptime;type:int4;comment:;size:10;"`            //exptime字段
